...
def train_model(model, train_loader, val_loader, optimizer, criterion, n_epochs=10,save_file='model.pt'):
    ...
    for epoch in range(n_epochs):
        ...
        for batch, (data_pre, len_pre, data_post, len_post, label) in enumerate(train_loader):
            ...
            if (batch+1) % 500 == 0:
                ...
                print('Epoch: [{}/{}], Step: [{}/{}],Training Acc: {}, Validation Acc: {}, Time: {} sec'.format(epoch+1, n_epochs, batch+1, len(train_loader), train_acc, val_acc, time.time()-start))
    ...
    #return model, loss, train_acc, val_acc
